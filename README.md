## apriltag_detector (kilted) - 3.1.0-1

The packages in the `apriltag_detector` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted apriltag_detector` on `Wed, 03 Dec 2025 15:57:46 -0000`
...
## apriltag_detector (rolling) - 3.0.4-1

The packages in the `apriltag_detector` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling apriltag_detector` on `Mon, 01 Sep 2025 15:43:26 -0000`
...
## apriltag_detector (rolling) - 3.0.3-1

The packages in the `apriltag_detector` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling apriltag_detector` on `Tue, 29 Jul 2025 13:36:51 -0000`
...
## apriltag_detector (kilted) - 3.0.3-1
